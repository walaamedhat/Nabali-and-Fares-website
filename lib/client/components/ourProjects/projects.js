    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'h3',
            { style: { margin: '0', color: '#3da5f9', padding: '9px 15px 0 0' } },
            data.name
          ),
          _react2.default.createElement(
            'h6',
            { style: { margin: '0', color: '#8492a6', padding: '5px 15px 0 0' } },
            data.description.substring(0, 151),
            '...'
          ),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              'div',
              { className: 'project-content-descAndIcon' },
              _react2.default.createElement(
                'h6',
                null,
          ...
          _react2.default.createElement(
            'div',
            { className: 'mediacenter__bottom__readmore show-more', id: data._id, onClick: this.view },
            '\u0639\u0631\u0636 \u0627\u0644\u0645\u0632\u064A\u062F',
            _react2.default.createElement(
              'span',
              null,
