...
import AddProject from '../../actions/projectsActions/addProjectsAction';
...
class OurProjects extends Component {
  ...
  handleInputChange = (e) =>{
    if(e.target.name === 'apartmentType'){        
        let arr = []
...
const mapStateToProps = store => {   
  return {
    filesUrl: store.filesUrl,
    isFetching: store.filesUrl.isFetching,
    massage : store.filesUrl.massage,
    isAddingDone: store.projectsData.addingDone
  }
}
